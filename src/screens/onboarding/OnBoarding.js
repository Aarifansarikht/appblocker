...
import { CONTAINER_SPACING, SCREEN_FONT_SCALE, SCREEN_HEIGHT, SCREEN_WIDTH } from "../../utils/constants";
...
const data = [
  {
    ...
    description: "ScreenToSkill turns your screen time into skill time — helping you grow smarter every day.",
  },
  // {
  //   image:
  ...
  // },
  {
    ...
    description: "Complete quick challenges to unlock apps — turning every unlock into a moment of learning.",
  },
];
const OnBoarding = () => {
            ...
            >
              ...
              <View style={styles.contentContainer}>
                <View style={{ marginBottom: 8 }}>
                  <Text style={[styles.heading, { color: colors.blackPrimary }]}>{item.heading}</Text>
                </View>
                <View>
                  <Text style={[styles.paragraph, { color: colors.paragraph }]}>{item.description}</Text>
                </View>
              </View>
            </View>
          );
      ...
      <View style={styles.indicatorContainer}>
        {data?.map((item, index) => {
          const indicatorStyle = {
            backgroundColor: currentSlideIndex === index ? colors.accent : colors.paragraphLight,
            width: currentSlideIndex === index ? 20 : 5,
          };
          return <View key={index} style={[styles.indicator, indicatorStyle]} />;
        })}
      </View>
    );
  };
  ...
  return (
    <Container>
      <View style={styles.container}>
        ...
        >
          <TouchableOpacity onPress={goToNextSlide} style={[styles.nextButton, { backgroundColor: colors.accent }]}>
